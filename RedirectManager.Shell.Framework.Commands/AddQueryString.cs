...
{
    [Serializable]
	public class AddQueryString : Command
    {
        public override void Execute(CommandContext context)
        {
            ...
            {   
                ...
                context.Parameters.Add("database", context.Items[0].Database.Name.ToString());
                Context.ClientPage.Start("uiAddQueryString", context.Parameters);
            }
        }
